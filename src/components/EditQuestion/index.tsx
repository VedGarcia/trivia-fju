...
import { updateQuestion } from "../../features/admin/questionsSlice";
...
export const EditQuestion = ({ question, onSuccess }: EditQuestionProps) => {
  ...
  const methods = useForm<QuestionFormData>({
    defaultValues: {
      text: question.text,
      answerOptions: question.answerOptions.map((opt) => ({ text: opt.text })),
